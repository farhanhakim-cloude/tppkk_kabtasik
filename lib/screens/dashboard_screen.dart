    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Row(
            children: [
              _LegendDot(color: Color(0xFF10B981), label: 'Gizi Baik'),
              SizedBox(width: 16),
              _LegendDot(color: Color(0xFFF59E0B), label: 'Gizi Kurang'),
              SizedBox(width: 16),
              _LegendDot(color: Color(0xFFEF4444), label: 'Gizi Buruk'),
            ],
          ),
          const SizedBox(height: 16),
          SizedBox(
