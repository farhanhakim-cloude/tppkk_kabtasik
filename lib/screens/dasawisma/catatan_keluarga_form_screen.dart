...
class _CatatanKeluargaFormScreenState extends State<CatatanKeluargaFormScreen> {
  ...
  @override
  void dispose(){ _dasaWismaCtrl.dispose(); _rtCtrl.dispose(); _rwCtrl.dispose(); _dusunCtrl.dispose(); _desaCtrl.dispose(); _kecCtrl.dispose(); _catatanDariCtrl.dispose(); _ketUmumCtrl.dispose(); for(final a in _anggota) a.dispose(); super.dispose(); }
